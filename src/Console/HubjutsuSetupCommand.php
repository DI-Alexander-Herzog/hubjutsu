...
class HubjutsuSetupCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->copyDirectoryIfNotExists(__DIR__.'/../../stubs/resources/js/Helper', resource_path('js/Helper'));
        ...
        $this->copyDirectoryIfNotExists(__DIR__.'/../../stubs/app/Jobs/', app_path('Jobs'));
        ...
        $this->copyDirectoryIfNotExists(__DIR__.'/../../stubs/config/', config_path());
