    ...
    return (
        ...
        >
            <div className="mt-2 mb-4">
                <div className="mx-auto max-w-7xl rounded-md border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/60 px-3 py-2">
                    <div className="flex items-start justify-between gap-3">
                        <div>
                            <div className="text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Kursstruktur</div>
                            <div className="mt-1 text-sm text-gray-700 dark:text-gray-300">Kontext zur aktuellen Lektion</div>
                        </div>
                        <NeutralButton
                            size="small"
                    ...
                    {showStructureDetails && (
                        <div className="mt-3 grid gap-3 md:grid-cols-3">
                            <a
                                href={courseEditUrl}
                                className="block rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-3 hover:border-primary"
                            >
                                <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Kurs</div>
                                <div className="flex items-start gap-3">
                                    {courseCover ? (
                                        <img src={courseCover} alt={courseName || 'Kurs'} className="h-16 w-16 rounded object-cover" />
                                    ) : (
                                        <div className="flex h-16 w-16 items-center justify-center rounded border border-dashed border-gray-300 dark:border-gray-600 text-[10px] text-gray-400 dark:text-gray-500">
                                            Kein Bild
                                        </div>
                                    )}
                                    <div className="min-w-0">
                                        <div className="text-sm font-medium text-gray-900 dark:text-gray-100">{courseName || '-'}</div>
                                        {course?.description ? (
                                            <div className="mt-1 text-xs text-gray-600 dark:text-gray-400">{course.description}</div>
                                        ) : null}
                                    </div>
                                </div>
                            </a>
                            ...
                            <a
                                ...
                                className="block rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-3 hover:border-primary"
                            >
                                <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Modul</div>
                                <div className="flex items-start gap-3">
                                    {moduleCover ? (
                                    ...
                                    <div className="min-w-0">
                                        <div className="text-sm font-medium text-gray-900 dark:text-gray-100">{moduleName || '-'}</div>
                                        {module?.description ? (
                                            <div className="mt-1 text-xs text-gray-600 dark:text-gray-400">{module.description}</div>
                                        ) : null}
                                    </div>
                                </div>
                            </a>
                            ...
                            <a
                                ...
                                className="block rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-3 hover:border-primary"
                            >
                                <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Sektion</div>
                                <div className="text-sm font-medium text-gray-900 dark:text-gray-100">{sectionName || '-'}</div>
                                {section?.description ? (
