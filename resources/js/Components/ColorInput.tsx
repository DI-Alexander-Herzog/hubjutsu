...
const textInputClass =
	"text-sm w-full px-2 py-2 border border-gray-300 dark:border-gray-600 bg-background dark:bg-gray-700 disabled:bg-background-600 disabled:dark:bg-gray-800 text-text-900 dark:text-gray-100 focus:ring-2 focus:ring-primary focus:border-primary rounded-md";
