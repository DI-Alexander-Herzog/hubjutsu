        ...
        <Link
            ...
            className={`w-full flex items-start ps-3 pe-4 py-2 border-l-4 ${
                active
                    ...
                    : 'border-transparent text-text-600 dark:text-gray-400 hover:text-text-800 dark:hover:text-gray-200 hover:bg-background-600 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus:text-text-800 dark:focus:text-gray-200 focus:bg-background-600 dark:focus:bg-gray-700 focus:border-gray-300 dark:focus:border-gray-600'
